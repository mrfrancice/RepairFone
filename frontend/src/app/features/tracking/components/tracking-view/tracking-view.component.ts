    ...
    <div class="tracking-container">
      ...
      @if (isLoading()) {
        ...
        <div class="tracking-content">
          ...
          <!-- Rating Section -->
          @if (canShowRatingSection()) {
            <section class="section rating-section">
              <div class="section-header">
                <h2>⭐ Noter le réparateur</h2>
              </div>

              @if (!showRatingForm()) {
                <div class="rating-prompt">
                  <p>Comment se passe votre expérience avec ce réparateur ?</p>
                    ...
                    @for (step of getAvailableRatingSteps(); track step.key) {
                      ...
                      >
                        ...
                        @if (isStepRated(step.key)) {
                          <span class="rated-badge">✓ Noté</span>
                        }
                      </button>
                    }
                  </div>
                      ...
                      <div class="ratings-summary">
                        @for (rating of stepRatings(); track rating.id) {
                          <div class="rating-item">
                            <span class="rating-category">{{ reviewsService.getCategoryLabel(rating.category) }}</span>
                            <span
                              class="rating-value"
