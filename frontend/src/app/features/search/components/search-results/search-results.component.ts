                ...
                <a [routerLink]="['/search/repairer', repairer.id]" class="card-link">
                  ...
                  <div class="repairer-info">
                    ...
                    <div class="repairer-rating">
                      <span
                        class="rating-score"
                        [style.background]="reviewsService.getStepRatingColor(repairer.repairerProfile.rating)"
                      >
                        {{ reviewsService.formatStepRating(Math.round(repairer.repairerProfile.rating)) }}
                      </span>
                      <span class="rating-label">{{ reviewsService.getStepRatingLabel(repairer.repairerProfile.rating) }}</span>
                      <span class="review-count">({{ repairer.repairerProfile.reviewCount }} avis)</span>
