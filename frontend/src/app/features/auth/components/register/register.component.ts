...
const DEVICE_SPECIALTIES = [
  'iPhone', 'Samsung', 'Huawei', 'Xiaomi', 'Oppo', 'Tecno', 'Infinix', 'Nokia',
  'Tablettes', 'iPad', 'MacBook', 'Ordinateurs portables',
  'Écrans', 'Batteries', 'Connecteurs de charge', 'Caméras',
  'Cartes mères', 'Déblocage', 'Récupération de données'
];
...
export class RegisterComponent implements OnInit {
  ...
  readonly deviceSpecialties = DEVICE_SPECIALTIES;
