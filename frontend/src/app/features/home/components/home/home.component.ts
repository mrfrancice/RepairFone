...
export class HomeComponent implements OnInit {
  ...
  readonly quickServices: QuickService[] = [
    { id: 'screen', icon: '📱', label: 'Écran cassé', color: 'rgba(239, 68, 68, 0.1)' },
    { id: 'battery', icon: '🔋', label: 'Batterie', color: 'rgba(34, 197, 94, 0.1)' },
    { id: 'charging', icon: '🔌', label: 'Connecteur', color: 'rgba(59, 130, 246, 0.1)' },
    { id: 'water', icon: '💧', label: 'Oxydation', color: 'rgba(147, 51, 234, 0.1)' },
    { id: 'camera', icon: '📷', label: 'Caméra', color: 'rgba(245, 158, 11, 0.1)' },
  ];

  readonly problemCategories = [
    { id: '1', icon: '📱', name: 'Écran cassé' },
    { id: '2', icon: '🔋', name: 'Batterie' },
    { id: '3', icon: '💧', name: 'Oxydation' },
    { id: '4', icon: '🔌', name: 'Connecteur' },
    { id: '5', icon: '📷', name: 'Caméra' },
    { id: '6', icon: '🔊', name: 'Son' },
    { id: '7', icon: '⚡', name: 'Charge' },
    { id: '8', icon: '❓', name: 'Autre' },
  ];
